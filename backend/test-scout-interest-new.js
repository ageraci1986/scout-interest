...
async function testScoutInterestNew() {
  console.log('🧪 Testing new scout-interest-new deployment...');
  
  const baseURL = 'https://scout-interest-oypcdz93l-angelo-geracis-projects.vercel.app';
...
// Exécuter le test
testScoutInterestNew().catch(console.error);
