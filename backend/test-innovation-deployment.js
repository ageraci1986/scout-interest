...
async function testInnovationDeployment() {
  console.log('🧪 Testing new innovation deployment...');
  
  const baseURL = 'https://innovation-dpp9r592l-angelo-geracis-projects.vercel.app';
...
// Exécuter le test
testInnovationDeployment().catch(console.error);
