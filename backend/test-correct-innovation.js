...
async function testCorrectInnovation() {
  console.log('🧪 Testing correct innovation URL...');
  
  const baseURL = 'https://innovation-taupe.vercel.app';
...
// Exécuter le test
testCorrectInnovation().catch(console.error);
